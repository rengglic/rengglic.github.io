...
Previously, I was a PostDoc at UZH's [DaST](https://www.ifi.uzh.ch/en/dast.html) with [Dan Olteanu](https://www.ifi.uzh.ch/en/dast/people/Olteanu.html) and defended my thesis at ETH's [System Group](https://systems.ethz.ch) with [Ce Zhang](https://zhangce.github.io). During my PhD, I have worked as a research intern and student research consultant at Google Brain (now Google DeepMind).
